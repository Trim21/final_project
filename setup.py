...
from net_cloud import __version__, __author__, __email__

with open('./requirements.txt', 'r') as f:
    requirements = f.read().splitlines()
    if sys.version_info[1] < 5:
        # install typing when python version lower than 3.6
...
setup(
    ...
    keywords='trim21, cloud',
    description='web cloud with file on demand',
    ...
    entry_points={
        'console_scripts': [
            'trim21_cloud_client = trim21.cloud.client.controllers.main.main',
        ]
    },
    license='MIT License',
